...
(7) make_movie.m makes a movie in which the plotted objects given by the input ar- gument handle are rotated around the z-axis. Call it as make_movie(handle,rho).
...
[3] M. Cameron and S. Yang, Visualization and analysis of stochastic Lorenz’63 by means of computing the quasipotential, submitted, arXiv:
